...
**roman9898**<br>
Roman’s inputs are extremely frequent and very unnatural, compared to any run covered in [section 3.3]({{site.baseurl}}/tmx-investigation-1#3-comparing-different-analog-devices). In the presented run, roman achieved a maximum of 25 spikes per second, and his average totals 10. However, given the amount of replays uploaded by this player, we are unable to determine if they used external programs to achieve this run.
